...
| `farbomat.v2m` | v3 | fr-minus-03 farbomat (party) | `fr-minus-03-party.zip` `4a7e7b5b941e…` | `87ac3a7cbb56e01d…` | author-suggested v2 lead (Tammo, 2026-06); carved = **v3**, not v2 — aplib stub stops early but image+carve valid |
...
fr-036 zeitmaschine (the known-hard ones). fr-minus-03 farbomat is now carved
(above) — its aplib stub stops on an invalid instruction at eip=0x40000c but the
2.75 MB image is already valid and `era carve` recovers the one 9-channel song.
